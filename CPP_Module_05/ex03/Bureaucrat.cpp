...
/*   Updated: 2022/02/20 14:42:29 by murachid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if(this->grade  > obj.get_garde_to_excute())
         std::cout << this->name << " couldn’t excute because grade is too low"<< std::endl;  
    else
        std::cout << this->name << " excuted " << obj.get_name()  << std::endl;
}
